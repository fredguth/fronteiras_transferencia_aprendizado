...
\subsection{As Fronteiras}\label{fronteiras}
  ...
  Utilizamos o \emph{ScatterText}~\cite{kessler2017scattertext} para analisar as diferenças dos termos que representam os artigos da  "Busca3anos", que são mais prováveis de estar na fronteira de pesquisa, com os termos da "Busca10Anos" engloba todos os artigos sobre TL. 
